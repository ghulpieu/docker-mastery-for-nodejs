...
//   docker container run -v ${PWD}/in:/app/in -v ${PWD}/out:/app/out --env CHARCOAL_FACTOR=10 node-mta
...
var inDir          = './in',
    outDir         = './out',
    logDir         = './logs',
    charcoalFactor = process.env.CHARCOAL_FACTOR || 0.1; // ideally 0.1 to 1.0

const logger = winston.createLogger({
  level: 'info',
  format: winston.format.simple(),
  transports: [
    // output to stdout stderr for Docker
